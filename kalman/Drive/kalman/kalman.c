...
//卡尔曼滤波 10msec(100Hz)每次执行
#define theta_update_freq  		100							//100Hz
#define theta_update_interval   (1.0/theta_update_freq) 	//10msec
#define	MPU_gRes				16.4f						//根据陀螺仪传感器设置,±2000dps(越大越好),  2^16/4000=16.4 
...
float theta_deg;					//测量角度
float theta_deg2;					//卡尔曼滤波后的角度
float theta_dot;					//测量角速度
float theta_dot2;					//减去偏差的角速度
